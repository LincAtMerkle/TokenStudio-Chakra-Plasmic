...
import sty from './PlasmicNewPage3.module.css'; // plasmic-import: Nnimi9y55K/css
    ...
    () => [
      {
        ...
        type: 'private',
        variableType: 'text',
        initFunc: ({ $props, $state, $queries, $ctx }) => 'green' as const,
      },
    ],
    [$props, $ctx, $refs]
  );
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            ...
            <Button
              className={classNames('__wab_instance', sty.chakraUiButton__gs09)}
              size={'md' as const}
              variant={'primary2' as const}
            >
              <div
          ...
          <Button
            className={classNames('__wab_instance', sty.chakraUiButton__i1G2I)}
            size={'md' as const}
            variant={'primary2' as const}
          >
            <div
