...
type VariantPropType = keyof PlasmicLoginWithGradient__VariantsArgs;
export const PlasmicLoginWithGradient__VariantProps =
  new Array<VariantPropType>();

export type PlasmicLoginWithGradient__ArgsType = {};
type ArgPropType = keyof PlasmicLoginWithGradient__ArgsType;
...
export interface DefaultLoginWithGradientProps {
  className?: string;
}
...
function PlasmicLoginWithGradient__RenderFunc(props: {
  variants: PlasmicLoginWithGradient__VariantsArgs;
  args: PlasmicLoginWithGradient__ArgsType;
  overrides: PlasmicLoginWithGradient__OverridesType;
  forNode?: string;
}) {
...
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicLoginWithGradient__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicLoginWithGradient__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
  ...
  const func = function <T extends PropsType>(
    ...
    return PlasmicLoginWithGradient__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
...
export default PlasmicLoginWithGradient;
/* prettier-ignore-end */
