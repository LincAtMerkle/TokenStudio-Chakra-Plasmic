...
type VariantPropType = keyof PlasmicLoginWithFlushedInputs__VariantsArgs;
export const PlasmicLoginWithFlushedInputs__VariantProps =
  new Array<VariantPropType>();

export type PlasmicLoginWithFlushedInputs__ArgsType = {};
type ArgPropType = keyof PlasmicLoginWithFlushedInputs__ArgsType;
...
export interface DefaultLoginWithFlushedInputsProps {
  className?: string;
}
...
function PlasmicLoginWithFlushedInputs__RenderFunc(props: {
  variants: PlasmicLoginWithFlushedInputs__VariantsArgs;
  args: PlasmicLoginWithFlushedInputs__ArgsType;
  overrides: PlasmicLoginWithFlushedInputs__OverridesType;
  forNode?: string;
}) {
...
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicLoginWithFlushedInputs__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicLoginWithFlushedInputs__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
  ...
  const func = function <T extends PropsType>(
    ...
    return PlasmicLoginWithFlushedInputs__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
...
export default PlasmicLoginWithFlushedInputs;
/* prettier-ignore-end */
