        ...
        <Container pt={{ base: '16', md: '24' }} pb={{ base: '28', md: '40' }}>
          <Stack spacing={{ base: '8', md: '10' }} align="center">
            <Stack spacing={{ base: '4', md: '5' }} textAlign="center">
              <Stack spacing="3">
                <Text fontSize={{ base: 'sm', md: 'md' }} fontWeight="semibold" color="pink.50">
                  Features
                </Text>
      ...
      <Box bg="bg-surface">
        <Container>
          ...
          >
            <picture>
              <source
                srcSet={`/screenshots/showcase/neutral/480-${colorMode}.png`}
                media="(max-width: 40em)"
              />
              <source
                srcSet={`/screenshots/showcase/neutral/768-${colorMode}.png`}
                media="(max-width: 62em)"
              />
              <Image
                alt="Feature Hero Image"
                src={`/screenshots/showcase/neutral/1440-${colorMode}.png`}
                objectFit="cover"
              />
            </picture>
          </Box>
