import { Box, BoxProps,Button, Flex, Heading, SimpleGrid, Text, useColorModeValue } from '@chakra-ui/react'
...
export function App({
  ...
  return (
    <Box 
    className={className}
    as="section" bg={useColorModeValue('gray.50', 'gray.800')} py="24">
    <Box maxW={{ base: 'xl', md: '7xl' }} mx="auto" px={{ base: '6', md: '8' }}>
      ...
      <Flex align="center" justify={{ base: 'center', lg: 'flex-start' }} my="10">
      ...
      <SimpleGrid mt="10" columns={{ base: 1, lg: 3 }} spacing="10">
        <PricingCard
          ...
          color="white"
          button={
            <Button w="full" size="lg" h="16" colorScheme="pink">
              Start for Free
            </Button>
          }
          data={{
        ...
        <PricingCard
          ...
          color="white"
          button={
            <Button w="full" h="16" colorScheme="pink" size="lg">
              Add to cart
            </Button>
          }
          data={{
